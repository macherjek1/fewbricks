 ...
 */
class flexible_columns extends project_brick
{
    /**
     * @var string
     */
    protected $label = 'Spalten Layout';
    /**
     *
     */
    public function set_fields()
    {
        ...
        for ($column_nr = 1; $column_nr <= $nr_of_columns; $column_nr++) {
            ...
            $this->add_brick(new flexible_brick('fb' . $column_nr, '1509141034a' . $column_nr));
        }
    ...
    protected function get_brick_html()
    {
        ...
        for ($column_nr = 1; $column_nr <= $nr_of_columns; $column_nr++) {
            ...
            $html .= $this->get_child_brick('flexible_brick', 'fb' . $column_nr)->get_html();
            $html .= '</div>';
        }
        $html .= '
        </div>
